#/bin/sh
# RCS Id: $Id: T0105.sh,v 1.1.1.1 2002/10/24 19:50:03 mohsen Exp $
...
echo "To: mohsen@neda.com"				>> ${TMP_FILE}
echo "Subject: Test 1.5  ${DATE}"			>> ${TMP_FILE}
...
cp ${TMP_FILE}  ${UA_SPOOL}/S_0105${SEC}
