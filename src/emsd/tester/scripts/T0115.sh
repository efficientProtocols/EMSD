#/bin/sh
# RCS Id: $Id: T0115.sh,v 1.1.1.1 2002/10/24 19:50:03 mohsen Exp $
...
echo "Subject: Test 1.15  ${DATE}"			>> ${TMP_FILE}
...
cat /usr/pub/eqnchar		 			>> ${TMP_FILE}

cp ${TMP_FILE} ${UA_SPOOL}/S_0115${MIN}
