#/bin/sh
# RCS Id: $Id: T0206.sh,v 1.1.1.1 2002/10/24 19:50:03 mohsen Exp $
...
echo "To: EMSD=88889"					>> ${TMP_FILE}
echo "Subject: Test 2.6  ${DATE}"			>> ${TMP_FILE}
echo "MIME-Version: 1.0"				>> ${TMP_FILE}
echo "Content-Type: TEXT/PLAIN; charset=US-ASCII"	>> ${TMP_FILE}
echo ""							>> ${TMP_FILE}
date							>> ${TMP_FILE}

cp ${TMP_FILE}  ${UA_SPOOL}/S_0206${MIN}
