#/bin/sh
# RCS Id: $Id: T0106.sh,v 1.1.1.1 2002/10/24 19:50:03 mohsen Exp $
...
echo "To: EMSD=99199"					>> ${TMP_FILE}
echo "Subject: Test 1.6  ${DATE}"			>> ${TMP_FILE}
...
cp ${TMP_FILE}  ${UA_SPOOL}/S_0106${SEC}
