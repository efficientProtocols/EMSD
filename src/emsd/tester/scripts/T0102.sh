#/bin/sh
# RCS Id: $Id: T0102.sh,v 1.1.1.1 2002/10/24 19:50:03 mohsen Exp $
...
echo "Subject: Test 1.2  ${DATE}"			>> ${TMP_FILE}
...
cp /tmp/NedaTest.tmp ${UA_SPOOL}/S_0102${MIN}
