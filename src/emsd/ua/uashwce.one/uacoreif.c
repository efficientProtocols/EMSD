...
/*
 * 
 * History: copy-and-edit based on uashpine.one/uacoreif.c
 *
 */
		...
		void *hShellReference)
{
    ...
    TM_TRACE((uash_globals.hModCB, UASH_TRACE_DETAIL,
	    ...
	    "%s",
	    (unsigned long) hMessage,
	    bTransient ? "Transient Error" : "No more attempts"));
		         ...
		         void *hShellReference)
{
    ...
    sprintf(buf, "Delivery request failed! No response from Message Center %s", 
