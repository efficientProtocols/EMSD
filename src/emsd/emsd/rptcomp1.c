			     ...
			     QU_Head * pQ)
{
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Sequence,
		  ...
		  NULL,
		  "Report Delivery",
		  ("emsd_compileReportDelivery: sequence"));
    ...
    RC_CALL(rc,
	    emsd_compileMessageId1_1((unsigned char *) pCStruct,
				    ...
				    0, pQ,
				    "Message Id"),
	    ("emsd_compileReportDelivery: Message ID"));
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Sequence,
		  ...
		  NULL,
		  "Returned Content",
		  ("emsd_compileReportDelivery: returned content sequence"));
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Buffer,
		  ...
		  "Returned Content",
		  ("emsd_compileReportDelivery: returned content"))
			  ...
			  char * pMessage)
{
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_SequenceOf, tag, pQ,
		  ...
		  &pPerRecipData->count,
		  pMessage,
		  ("compilePerRecipReportData: sequence of"));
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Sequence,
		  ...
		  ("compilePerRecipReportData: sequence"));
    ...
    RC_CALL(rc,
	    emsd_compileORAddress1_1((unsigned char *) pCStruct,
				    ...
				    0, pQ,
				    "Recipient Address"),
	    ("compilePerRecipReportData: recipient address"));
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Choice, 0, pQ,
		  ...
		  "Per-recip Report Data",
		  ("compilePerRecipReportData: choice"));
    ...
    RC_CALL(rc,
	    compileDeliveryReport((unsigned char *) pCStruct,
				  ...
				  ASN_TAG_CONTEXT(0), pQ,
				  "Delivery Report"),
	    ("compilePerRecipReportData: delivery report"));
    ...
    RC_CALL(rc,
	    compileNonDeliveryReport((unsigned char *) pCStruct,
				     ...
				     "Non-Delivery Report"),
	    ("compilePerRecipData: non-delivery report"));
		      ...
		      char * pMessage)
{
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Sequence, tag, pQ,
		  ...
		  NULL,
		  pMessage,
		  ("compileDeliveryReport: sequence"));
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Integer,
		  ...
		  ("compileDeliveryReport: message delivery time"));
			 ...
			 char * pMessage)
{
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Sequence, tag, pQ,
		  ...
		  NULL,
		  pMessage,
		  ("compileNonDeliveryReport: sequence"));
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Integer,
		  ...
		  "Non-Delivery Reason",
		  ("compileNonDeliveryReport: reason"));
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_Integer,
		  ...
		  ("compileNonDeliveryReport: diagnostic"));
    ...
    ASN_NEW_TABLE(pTab, ASN_Type_OctetString,
		  ...
		  "Explanation",
		  ("compileNonDeliveryReport: explanation"));
